      ...
      ? <Flex alignCenter>
        {
          ...
          ? <>
              <Span
              xs pointer bg='blueBox' color='white' borderRadius='5px 0 0 5px' px={10} py='5px' mr={'-10px'}
              onClick={this.login}>
                {
                  isLoading
              ...
              <Popover content={<ProfilePreview box={box} profile={box.profile}/>} >
                <Avatar src={boxLogo} width={40} borderRadius={9999} />
              </Popover>
            </>
          : <>
            <Span xs bg='blueBox' color='white' borderRadius='5px 0 0 5px' px={10} py='5px' mr={'-10px'}>
